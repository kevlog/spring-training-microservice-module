...
public class AuthServiceImpl implements AuthService {
        ...
        try {
            ...
            if (!errors.isEmpty()) {
                ...
                return new ResponseEntity<>(
                        new ResTemplateDto(errors, "Email or username has already been registered."),
            ...
            return new ResponseEntity<>(new ResTemplateDto(data, ConstantVariables.SUCCESS_MESSAGE),
                    HttpStatus.CREATED);
    ...
    public ResponseEntity<ResTemplateDto> validateToken(String authToken) {
        ...
        return new ResponseEntity<ResTemplateDto>(
                new ResTemplateDto(resValidateTokenDto, ConstantVariables.SUCCESS_MESSAGE), HttpStatus.OK);
    }
}
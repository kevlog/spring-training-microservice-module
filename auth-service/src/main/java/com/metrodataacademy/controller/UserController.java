...
public class UserController {
    ...
    // TODO: POST Mapping Update User
    @PostMapping("/update-profile")
    public ResponseEntity<ResTemplateDto> updateUser(@Valid @RequestBody ReqUpdateUserDto reqUpdateUserDto,
            @RequestHeader("Authorization") String authToken) {
        return userService.updateUser(reqUpdateUserDto, authToken);
    }

    // TODO: GET Mapping User Profile

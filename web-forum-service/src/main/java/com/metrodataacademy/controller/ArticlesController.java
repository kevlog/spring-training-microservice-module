...
public class ArticlesController {
    ...
    // TODO: POST Mapping List Articles
    @PostMapping("/list")
    ...
    // TODO: GET Mapping Get Article By Id
    @GetMapping("")
    public ResponseEntity<ResBaseDto> getArticlesById(@RequestParam String id) {
        return articlesService.getArticlesById(id);
    }

    // TODO: POST Mapping Create Article
    public ResponseEntity<ResBaseDto> insertArticle(@Valid @RequestBody ReqCreateArticlesDto reqCreateArticlesDto,
            HttpServletRequest servletRequest) {
        return articlesService.insertArticle(reqCreateArticlesDto, servletRequest);
    }

    // TODO: POST Mapping Update Article
    @PostMapping("/update")
    public ResponseEntity<ResBaseDto> updateArticle(@RequestParam String id,
            @Valid @RequestBody ReqCreateArticlesDto reqCreateArticlesDto, HttpServletRequest servletRequest) {
    ...
    // TODO: DELETE Mapping Delete Article

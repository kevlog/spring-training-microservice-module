...
public class PostServiceImpl implements PostService {
    ...
    private final ThreadsServiceImpl threadsServiceImpl;
    private final PostMapper postMapper;
    private final StagingUserMapper stagingUserMapper;

    @Override
    public ResponseEntity<ResBaseDto> createPostToThreads(ReqPostDto reqCommentThreadsPostDto,
            AuthorizationDto authDto) {
        // TODO: implementasi logic Create Post To Threads
        try {
            Post post = new Post();
    ...
    public ResponseEntity<ResBaseDto> getListPostFromThreads(String threadsId, String page) {
        // TODO: implementasi logic Get List Post From Threads
        Pageable pageable = PageRequest.of(Integer.parseInt(page) - 1, ConstantVariable.DATA_PER_PAGE);

...
public class AuthServiceRestTemplateImpl implements AuthServiceRestTemplate {
    ...
    public AuthorizationDto getLogin(String authToken) {
        // TODO: implementasi logic rest template ke auth service untuk autentikasi
        ...
        try {
            // request detail
            ResponseEntity<ResBaseValidateTokenDto> responseEntity = restTemplate.exchange(url + "/auth/validate-token",
                    HttpMethod.POST, entity, ResBaseValidateTokenDto.class);

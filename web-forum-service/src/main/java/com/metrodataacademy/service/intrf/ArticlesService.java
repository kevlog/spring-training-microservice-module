...
public interface ArticlesService {
    ...
    ResponseEntity<ResBaseDto> insertArticle(ReqCreateArticlesDto reqCreateArticlesDto,
    ...
    ResponseEntity<ResBaseDto> updateArticle(String id, ReqCreateArticlesDto reqCreateArticlesDto,
